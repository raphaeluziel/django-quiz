    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('correct_answer', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='correct_answer', to='quiz.answer')),
            ],
        ),
        migrations.CreateModel(
            name='Player',
            fields=[
                ...
                ('questions_answered', models.ManyToManyField(blank=True, to='quiz.question')),
            ],
        ),
        migrations.AddField(
            model_name='answer',
